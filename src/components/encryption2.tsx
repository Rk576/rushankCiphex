...
export function Encryption1() {
  ...
  const handleEncrypt = async () => {
    ...
    try {
      ...
      const response = await fetch("https://polite-tiphani-rk696969-681a7c3a.koyeb.app/audio_txt/encode/", {
        method: "POST",
        body: formData,
      });
      ...
      if (!response.ok) {
        ...
        toast({
          ...
          description: "Text successfully encrypted in audio",
          className: "bg-[#19182a]",
        });
      }
  ...
  return (
    <div className="w-[100%] h-[100%] pt-2">
      <div className="flex w-[100%] mt-2 bg-[#24182a] p-3 rounded-xl border border-[#5f476b] text-[#9d83ab]">
        ...
        <br /> Neither the audio file nor the message will be transmitted over
        the web, as everything happens within your browser.
      </div>
