...
export function AuthPage() {
    ...
    return (
        <div className={"w-[100%] min-h-[100vh] flex flex-col font-[family-name:var(--font-geist-mono)] gap-9 items-center justify-center md:px-0 px-3"}>
            <p className="text-5xl mb-3 mt-2 text-[#bbb0d3]">Ciphex</p>
            <Tabs defaultValue="login" className="w-[400px]">
                <TabsList className="grid w-full grid-cols-2 bg-[#19182a]">
                    ...
                    <Card>
                        ...
                        <CardFooter>
                            <Button onClick={handleLogin} disabled={loginLoading}>
                                {loginLoading ? <Loader2 className="animate-spin text-gray-300"/> : "Login"}
                            </Button>
                        </CardFooter>
                    </Card>
                </TabsContent>
