...
export function Decryption1() {
  ...
  const handleDecrypt = async () => {
    ...
    try {
      const response = await fetch("https://polite-tiphani-rk696969-681a7c3a.koyeb.app/img_text/decode/", {
        method: "POST",
        body: formData,
      });
      ...
      if (!response.ok) {
        ...
        toast({
          ...
          description: "Text successfully decrypted from image",
          className: "bg-[#19182a]",
        });
      }
        ...
        <CardContent className="space-y-6 py-5">
          ...
          {decodedText && (
            <div className="mt-4 p-4 bg-[#24182a] text-[#9d83ab] rounded-lg">
              <Label className="text-sm font-medium text-[#9d83ab]">
                Decrypted Text
              </Label>
